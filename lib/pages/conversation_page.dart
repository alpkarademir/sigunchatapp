...
import 'package:sigunchat/services/navigation_service.dart';
...
class _ConversationPageState extends State<ConversationPage> {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Row(
          children: <Widget>[
            CircleAvatar(
              backgroundImage: NetworkImage(this.widget._receiverImage),
            ),
            Padding(
              padding: const EdgeInsets.only(left: 10.0),
              child: Text(this.widget._receiverName),
            ),
          ],
        ),
        actions: <Widget>[
  ...
  Widget _userImageWidget() {
    double _imageRadius = _deviceHeight * 0.045;
    return Container(
      height: _imageRadius,
      width: _imageRadius,
  ...
  Widget _textMessageBubble(
    ...
    return Container(
      height: _deviceHeight * 0.07 + (_message.length / 20 * 4.0),
  ...
  Widget _messageField(BuildContext _context) {
    return Container(
      ...
      margin: EdgeInsets.symmetric(
          horizontal: _deviceWidth * 0.025, vertical: _deviceHeight * 0.02),
      child: Form(
        key: _formKey,
        child: Row(
  ...
  Widget _messageTextField() {
    return SizedBox(
      ...
      child: TextFormField(
        ...
        onSaved: (_input) {
          setState(() {
            _input = _editingController.text;
          });
        },
